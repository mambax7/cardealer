 ...
 * Class Workorder
 */
class Workorder extends \XoopsObject
{
    /**
     * Constructor
     *
    ...
    public function __construct()
    {
        ...
        $this->initVar('carnum', XOBJ_DTYPE_INT);
        $this->initVar('cost', XOBJ_DTYPE_INT);
        $this->initVar('orderdate', XOBJ_DTYPE_TIMESTAMP);
     ...
     *
     * @param null
     * @return Cardealer\Form\WorkorderForm
     */
    public function getForm()
    {
        $form = new Form\WorkorderForm($this);
        return $form;
    }
