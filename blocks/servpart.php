 ...
 * @return array
 */
function showCardealerServpart($options)
{

    $block         = [];
    $blockType     = $options[0];
    $servpartCount = $options[1];
    //$titleLenght = $options[2];

    /** @var \XoopsPersistableObjectHandler $servpartHandler */
    $servpartHandler = new Cardealer\ServpartHandler($GLOBALS['xoopsDB']);
    ...
    $criteria->setLimit($servpartCount);
